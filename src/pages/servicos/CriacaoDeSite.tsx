...
const features = [
  { icon: Zap, title: "Carregamento Instantâneo", description: "Sites ultrarrápidos que pontuam alto no Google (Core Web Vitals), garantindo melhor rankeamento." },
  { icon: Search, title: "Arquitetura para SEO", description: "Estrutura técnica otimizada para indexação e rankeamento nos motores de busca." },
  { icon: Smartphone, title: "Responsividade Total", description: "Layouts fluidos que se adaptam a qualquer tela. Garanta a melhor experiência para usuários mobile." },
];
...
const marqueeItems = ["PERFORMANCE", "SEO TÉCNICO", "SEGURANÇA DE DADOS", "DESIGN RESPONSIVO", "INTELIGÊNCIA DIGITAL"];
  ...
  return (
    <Layout>
      ...
      <section className="min-h-[80vh] flex items-center relative overflow-hidden bg-background pt-20">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold text-foreground mb-6 leading-[0.95] tracking-tight">
              Desenvolvemos Sites de <span className="text-primary">Alta Performance</span> para Escalar Seu Negócio
            </h1>
            
            <p className="text-lg text-muted-foreground mb-4 font-light">Soluções digitais robustas e seguras.</p>
            <p className="text-lg text-muted-foreground mb-8 font-light">Transformamos visitantes em clientes através de código limpo e estratégia.</p>

            <div className="flex flex-wrap gap-4 mb-8">
              {features.map((feature) => (
                <div key={feature.title} className="flex items-center gap-2 text-foreground">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild variant="hero" size="xl">
                <a href="#orcamento">Orçar Projeto <ArrowRight className="w-5 h-5" /></a>
              </Button>
      ...
      <section id="solucoes" className="section-padding bg-background">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-extrabold mb-4 tracking-tight">Nossas <span className="text-primary">Soluções</span></h2>
            <p className="text-muted-foreground max-w-2xl mx-auto font-light">Engenharia de software aplicada ao marketing. Criamos a base técnica necessária para sua empresa liderar o mercado digital.</p>
          </div>
          ...
          <div className="text-center mt-10">
            <Button asChild variant="hero" size="lg"><a href="#orcamento">Conhecer Detalhes</a></Button>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-card border-y border-border">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-extrabold text-foreground mb-4 tracking-tight">Metodologia de <span className="text-primary">Trabalho</span></h2>
            <p className="text-muted-foreground max-w-2xl mx-auto font-light">Processo estruturado para entregas ágeis e sem erros.</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {phases.map((phase) => (
              <div key={phase.number} className="border border-border rounded-lg p-6 relative overflow-hidden bg-background">
                <span className="absolute -top-4 -right-2 text-8xl font-bold text-primary/5">{phase.number}</span>
                <div className="relative">
                  <span className="text-primary font-bold text-sm">Fase {phase.number}</span>
                  <h3 className="text-lg font-bold text-foreground mt-1 mb-2">{phase.title}</h3>
                  <p className="text-muted-foreground text-sm font-light">{phase.description}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {cases.map((caseItem) => (
              <div key={caseItem.title} className="service-card group cursor-pointer">
                ...
                <h3 className="text-xl font-bold mt-2 mb-4 text-foreground group-hover:text-primary transition-colors">{caseItem.title}</h3>
                <Button variant="heroOutline" size="sm">Ver Detalhes ↗</Button>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="section-padding bg-card border-y border-border">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-extrabold mb-6 tracking-tight">Feedback de <span className="text-primary">Parceiros</span></h2>
            <blockquote className="text-lg md:text-xl text-foreground mb-6 italic font-light">
            ...
            <p className="text-muted-foreground font-semibold">TechSoluções Ltda. — Setor de Inovação</p>
          </div>
        ...
        <div className="container-custom">
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-5xl font-extrabold text-foreground mb-4 tracking-tight">Vamos Tirar Sua Ideia do <span className="text-primary">Papel?</span></h2>
              <p className="text-muted-foreground font-light">Conte sobre seu projeto e receba uma proposta técnica personalizada.</p>
            </div>
