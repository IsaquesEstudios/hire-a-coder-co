...
const specialties = [
  ...
  { name: "Software Sob Medida", desc: "Soluções únicas desenvolvidas para resolver o seu problema específico.", icon: "Cpu", accent: "340 75% 55%", span: "md:col-span-2" },
    ...
    <Layout>
      ...
      <section className="h-screen flex flex-col items-center justify-center relative overflow-hidden bg-background -mt-20">
        ...
        <div className="relative z-10 mb-8 animate-fade-in">
          <img src={logoIsaques} alt="Isaques Studios" className="h-10 md:h-14 opacity-70" />
        </div>
